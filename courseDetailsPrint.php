...
header('location:index.php');
  ...
  if(isset($_POST['submit']))
  {
    ...
    $retrieveSQL="select courseenrolls.course as cid, course.courseName as courname,course.courseCredit as Credit,session.session as session,department.department as dept,courseenrolls.enrollDate as edate ,semester.semester as sem from courseenrolls
                    ...
                    <div class="col-md-10">
                      ...
                      Course Details
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td></td>
                          <td> <?php echo $row_info['StudentRegno']; ?> </td>
                        </tr>
                        <tr>
                          <td></td>
                          ...
                          <td>:</td>
                          <td></td>
                          <td> <?php echo $row_info['studentName']; ?> </td>
...
?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $row_Course['semester'];?></td>
