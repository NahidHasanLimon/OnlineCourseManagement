...
$ret=mysqli_query($con,"insert into course(courseCode,courseName,courseCredit,noofSeats) values('$coursecode','$coursename','$courseCredit','$seatlimit')");
if($ret)
{
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="courseCredit" name="courseCredit" placeholder="courseCredit " required />
  </div>
